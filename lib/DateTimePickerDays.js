    ...
    React.createElement("div", {className: "datepicker-days", style: {display: 'block'}}, 
        React.createElement("table", {className: "table-condensed"}, 
          React.createElement("thead", null, 
            ...
            React.createElement("tr", null, 
              React.createElement("th", {className: "dow"}, "Пн"), 

              React.createElement("th", {className: "dow"}, "Вт"), 

              React.createElement("th", {className: "dow"}, "Ср"), 

              React.createElement("th", {className: "dow"}, "Чт"), 

              React.createElement("th", {className: "dow"}, "Пт"), 

              React.createElement("th", {className: "dow"}, "Сб"), 

              React.createElement("th", {className: "dow"}, "Вс")
            )
          ), 
